...
<div class="page-content">
        <div class="bg-stadium"><div class="section-content"><div class="max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8">
            <section class="flex flex-col justify-center items-center text-center pt-20 md:pt-32 pb-20 md:pb-32">
                <h1 class="text-4xl md:text-6xl font-black uppercase font-urbanist leading-tight fade-down"><span data-key="contact_title">Contactez-</span><span class="text-[#ccff00] title-glow" data-key="contact_highlight">nous</span></h1>
                ...
                <div class="mt-8 md:mt-12 flex flex-col sm:flex-row gap-4 md:gap-6 justify-center items-center">
                    ...
                    <a href="mailto:karimakon08@gmail.com" class="group relative inline-flex items-center justify-center gap-2 md:gap-3 px-6 md:px-10 py-2.5 md:py-4 bg-gradient-to-r from-red-600 to-red-700 rounded-xl text-white font-bold text-base md:text-xl tracking-wider transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/30 overflow-hidden w-full sm:w-auto plan-card-shake">
                    ...
                    <!-- زر الواتساب -->
                    <a href="https://wa.me/212670965351" target="_blank" class="group relative inline-flex items-center justify-center gap-2 md:gap-3 px-6 md:px-10 py-2.5 md:py-4 bg-gradient-to-r from-green-600 to-green-700 rounded-xl text-white font-bold text-base md:text-xl tracking-wider transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/30 overflow-hidden w-full sm:w-auto plan-card-shake">
                ...
                <div class="mt-12 text-gray-500 font-bold uppercase tracking-widest text-sm animate-pulse" data-key="contact_available">Support 24/7 Disponible</div>
            </section>
        </div></div></div>
    </div>
