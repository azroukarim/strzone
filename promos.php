...
<div class="page-content">
        ...
        <div class="bg-stadium"><div class="section-content"><div class="max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8">
            <div class="pb-20 pt-2 text-center">
                ...
                <div class="inline-block bg-gradient-to-br from-[#ccff00]/15 to-[#0a0a0a] border-2 border-[#ccff00] rounded-3xl p-10 max-w-2xl mx-auto shadow-[0_0_50px_rgba(204,255,0,0.2)] plan-card-shake transition-all duration-300">
                    <span class="text-7xl mb-6 block drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">⚽</span>
                    <h2 class="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tighter text-white" data-key="wc_promo_text">Prochainement, des offres exceptionnelles à l'occasion de la prochaine Coupe du Monde 2026.</h2>
