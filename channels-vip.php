...
<style>
    ...
    .channel-item { background: rgba(255, 255, 255, 0.03); border-radius: 0.75rem; padding: 0.6rem 1.2rem; transition: all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275); border-left: 4px solid #ffd700; font-size: 0.95rem; font-weight: 500; color: #eee; backdrop-filter: blur(5px); }
    .channel-item:hover { background: rgba(255, 215, 0, 0.1); transform: translateX(8px); border-left-width: 8px; color: #fff; }
    .category-title { background: linear-gradient(90deg, #ffd700, #fff); -webkit-background-clip: text; background-clip: text; color: transparent; font-size: 1.5rem; font-weight: 900; margin-top: 2.5rem; margin-bottom: 1.2rem; padding-bottom: 0.6rem; border-bottom: 2px solid rgba(255, 215, 0, 0.2); display: block; text-transform: uppercase; letter-spacing: 1px; }
    ...
    .result-count { background: rgba(255, 215, 0, 0.15); color: #ffd700; padding: 0.4rem 1.2rem; border-radius: 50px; font-size: 0.85rem; font-weight: 700; border: 1px solid rgba(255, 215, 0, 0.2); }
</style>
    ...
    <div class="section-content">
        <div class="max-w-[1600px] mx-auto px-4 md:px-6 lg:px-8">
            <section class="pt-20 pb-8 text-center">
                <h1 class="text-4xl md:text-7xl font-black uppercase mb-4 animate-heartbeat"><span>Plan</span> <span class="text-[#ffd700]">PREMIUM+VIP</span></h1>
            ...
            <div class="text-center py-12 my-6">
                <div class="bg-gradient-to-r from-[#ffd700]/10 to-transparent border border-[#ffd700]/30 rounded-2xl p-8 max-w-2xl mx-auto">
                    ...
                    <p class="text-gray-300 mb-6">Cliqueز ci-dessous pour souscrire au plan VIP et recevoir vos identifiants immédiatement sur WhatsApp</p>
