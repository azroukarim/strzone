    ...
    <div class="maint-container">
        ...
        <div class="maint-content">
            ...
            <div class="action-btns fade-up visible" style="transition-delay: 0.3s">
                ...
                <a href="index.php" class="back-home-btn" style="background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); color: white; padding: 0.5rem 1.2rem; border-radius: 100px; font-weight: 700; font-size: 0.75rem; text-decoration: none !important; transition: all 0.3s; display: flex; align-items: center; gap: 8px;">
                    ...
                    <span data-key="maint_back_btn">Retour à l'accueil</span>
                </a>
    ...
    <script>
        const translations = {
            fr: {
                ...
                maint_back_btn: "Retour à l'accueil",
